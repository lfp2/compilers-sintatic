...
public class brgccf_lfp2Parser extends Parser {
	...
	public static final int
		...
		T__5=25, T__4=26, T__3=27, T__2=28, T__1=29, T__0=30, WS=31, INTEGER_LITERAL=32, 
		OP=33, Identifier=34, Comment_line=35, Comment_ext=36;
	public static final String[] tokenNames = {
		...
		"WS", "INTEGER_LITERAL", "OP", "Identifier", "Comment_line", "Comment_ext"
	};
	public static final int
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public TerminalNode OP() { return getToken(brgccf_lfp2Parser.OP, 0); }
		public ExpressionContext expression(int i) {
			return getRuleContext(ExpressionContext.class,i);
		}
		public List<ExpressionContext> expression() {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						setState(202);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__27) | (1L << T__26) | (1L << T__14) | (1L << T__13) | (1L << T__11) | (1L << T__3) | (1L << INTEGER_LITERAL) | (1L << Identifier))) != 0)) {
							{
